...
<?php
        if(isset($_GET['id_jenis_Mobil']))
        {
            ...
            $query = "select * from jenis_mobil where id_jenis_Mobil='$id'";
        ...
        <header class="col-12 text-center tm-bg-black-transparent p-5 tes">
            ...
            <form method="post" action="ubah_jenis_db.php?id_jenis_Mobil=<?php echo $id ?>">
              ...
              <table width="1000px" style="item-align:left;">
                    <tr>
                        <td>Nama Jenis Mobil</td>
                        <td>:</td>
                        <td><input value="<?php echo $sel['nama_jenis_Mobil'] ?>"class="form-control rounded-0 border-top-0 border-right-0 border-left-0" type="text" name="nama" size="35"/></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td></td>
