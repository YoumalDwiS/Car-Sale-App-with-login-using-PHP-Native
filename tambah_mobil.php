    ...
    <div class="page-section">
      <div class="container">
        <header class="col-12 text-center tm-bg-black-transparent p-5 tes">
            <br>
            <br>
              <h2 class="text-uppercase mb-3 tm-app-feature-header">Tambah Mobil</h2>
              <form action="#" method="POST">
                ...
                <table width="1000px" style="item-align:left;"> 
                      ...
                      <tr>
                          <td>Stok Mobil</td>
                          <td>:</td>
                          <td><input class="form-control rounded-0 border-top-0 border-right-0 border-left-0" type="text" name="stok" size="35"/></td>
                      </tr>
                      <tr>
                          <td>Harga Mobil</td>
                          <td>:</td>
                          <td><input class="form-control rounded-0 border-top-0 border-right-0 border-left-0" type="text" name="harga" size="35"/></td>
                      </tr>
                      <tr>
                          <td></td>
                          <td></td>
          ...
          <?php
              ...
              if(isset($_POST['submit']))
              {
                  ...
                  $query="INSERT INTO mobil VALUES ('$new_id', '$jenis', '$nama','$stok','$harga')";
