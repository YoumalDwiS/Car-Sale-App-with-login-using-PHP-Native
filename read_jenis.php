    ...
    <div class="page-section">
      <div class="container">
        <header class="col-12 text-center tm-bg-white-transparent p-5 tes">
          <br> <br>
          <h2 class="text-uppercase mb-3 tm-app-feature-header">Lihat Jenis</h2>
            <button class="btn btn-primary" type="submit" name="submit" onClick='top.location="tambah_jenis.php"' value="insert" >Tambah</button>
              <br><br><br><br>
              <table class="table table-hover" style="width: 100%">
                    ...
                    <?php
                          include 'koneksi.php';
                          $baris=1;
                          $query = "SELECT `id_jenis_Mobil`, `nama_jenis_Mobil`, CASE
                          WHEN
                            `status_jenis_Mobil` = 1
                              THEN
                                'Aktif'
                          WHEN
                            `status_jenis_Mobil` = 0
                              THEN
                                'Tidak Aktif'
                        END AS status_jenis_Mobil FROM jenis_Mobil";
                  ...
                  <tr class="table-light">
                      ...
                      <td style="text-align:center">
                          ...
                          &nbsp;
                          <a href="#" onClick="confirm_modal('hapus_jenis.php?id_jenis_Mobil=<?php echo $row['id_jenis_Mobil'] ?>');">Hapus</a>
                      </td>
                  </tr>
                  <?php
                              $baris++;
